...
def update_pump(pump_id):
	...
	return ('You\'ve changed pump {} from {} to {}'.format(pump_id, prev_ingredient, ingredient))
...
if __name__ == "__main__":
	...
	while True:
		x = input('What you tryna do?\n1: Menu Inquiry\n2: Ingredient Inquiry\n3: Update Pump\n4: Thank You\n5: Drink Request')

		if x == '1':
			print(menu_inquiry())
		elif x == '2':
			print(ingredient_inquiry())
		elif x == '3':
			y = input ('What pump ID?')
			print(update_pump(y))
		elif x == '4':
			print(thank_you())
		elif x == '5':
